...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['testingCenter']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['testingCenter']['desc']; ?>">
        <!-- open graph data for social media display -->
        <meta property="og:title" content="<?=$metaContent['testingCenter']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['testingCenter']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['testingCenter']; ?>/>
        <meta property="og:type" content=<?= $metaContent['testingCenter']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['testingCenter']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['testingCenter']; ?> />
        <title><?=$titleContent['title']['testingCenter']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "testingCenterContent.php"; ?>
