...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['auditingContent']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['auditingContent']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['auditingContent']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['auditingContent']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['auditingContent']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['auditingContent']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['auditingContent']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['auditingContent']; ?> />
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <!-- page title -->
        <title><?=$titleContent['title']['auditingContent']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "auditingcontents.php"; ?>
