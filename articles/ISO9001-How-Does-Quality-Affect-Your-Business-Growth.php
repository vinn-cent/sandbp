...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['qualityAffect']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['qualityAffect']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['qualityAffect']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['qualityAffect']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['qualityAffect']; ?>/>
        <meta property="og:type" content=<?= $metaContent['qualityAffect']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['qualityAffect']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['qualityAffect']; ?> />
        <!-- page title -->

        <!-- mailchimp -->
        <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7_dtp.css" rel="stylesheet" type="text/css">
        <title><?=$titleContent['title']['qualityAffect']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "iso9001contents.php"; ?>
