...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['problemsolving']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['problemsolving']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['problemsolving']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['problemsolving']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['problemsolving']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['problemsolving']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['problemsolving']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href="<?= $canonicalTag['problemsolving']; ?>" />
        <!-- page title -->
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <title><?=$titleContent['title']['problemsolving']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "whatproblemcontent.php"; ?>
