...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['financialtransaction']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['financialtransaction']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['financialtransaction']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['financialtransaction']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['financialtransaction']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['financialtransaction']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['financialtransaction']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href="<?= $canonicalTag['financialtransaction']; ?>" />
        <!-- page title -->
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <title><?=$titleContent['title']['financialtransaction']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "messageformatcontent.php"; ?>
