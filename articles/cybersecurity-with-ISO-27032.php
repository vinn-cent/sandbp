...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['cyberSecurity']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['cyberSecurity']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['cyberSecurity']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['cyberSecurity']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['cyberSecurity']; ?>/>
        <meta property="og:type" content=<?= $metaContent['cyberSecurity']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['cyberSecurity']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['cyberSecurity']; ?> />
        <!-- page title -->

        <!-- mailchimp -->
        <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7_dtp.css" rel="stylesheet" type="text/css">
        <title><?=$titleContent['title']['cyberSecurity']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "ISO27032contents.php"; ?>
