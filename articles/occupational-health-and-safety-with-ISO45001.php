...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['improvingHealth']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['improvingHealth']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['improvingHealth']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['improvingHealth']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['improvingHealth']; ?>/>
        <meta property="og:type" content=<?= $metaContent['improvingHealth']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['improvingHealth']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['improvingHealth']; ?> />
        <!-- page title -->

        <!-- mailchimp -->
        <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7_dtp.css" rel="stylesheet" type="text/css">
        <title><?=$titleContent['title']['improvingHealth']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "safetyContents.php"; ?>
