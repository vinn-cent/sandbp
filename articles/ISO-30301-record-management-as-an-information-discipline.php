...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['recordManagement']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['recordManagement']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['recordManagement']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['recordManagement']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['recordManagement']; ?>/>
        <meta property="og:type" content=<?= $metaContent['recordManagement']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['recordManagement']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['recordManagement']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['recordManagement']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "recordmanagementcontent.php"; ?>
