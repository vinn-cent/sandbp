...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['complaintmanagement']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['complaintmanagement']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['complaintmanagement']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['complaintmanagement']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['complaintmanagement']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['complaintmanagement']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['complaintmanagement']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href="<?= $canonicalTag['complaintmanagement']; ?>" />
        <!-- page title -->
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <title><?=$titleContent['title']['complaintmanagement']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "guidelinescontents.php"; ?>
