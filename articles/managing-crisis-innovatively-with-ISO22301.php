...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['businessContinuity']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['businessContinuity']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['businessContinuity']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['businessContinuity']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['businessContinuity']; ?>/>
        <meta property="og:type" content=<?= $metaContent['businessContinuity']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['businessContinuity']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['businessContinuity']; ?> />
        <!-- page title -->

        <!-- mailchimp -->
        <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7_dtp.css" rel="stylesheet" type="text/css">
        <title><?=$titleContent['title']['businessContinuity']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "iso22301-contents.php"; ?>
