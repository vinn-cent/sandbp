...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['benefitOfISO27001']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['benefitOfISO27001']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['benefitOfISO27001']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['benefitOfISO27001']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['benefitOfISO27001']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['benefitOfISO27001']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['benefitOfISO27001']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['benefitOfISO27001']; ?> />
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <!-- page title -->
        <title><?=$titleContent['title']['benefitOfISO27001']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "benefitOfISO27001.php"; ?>
