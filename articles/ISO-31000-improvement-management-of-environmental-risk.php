...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['environmentalMgtRisk']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['environmentalMgtRisk']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['environmentalMgtRisk']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['environmentalMgtRisk']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['environmentalMgtRisk']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['environmentalMgtRisk']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['environmentalMgtRisk']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['environmentalMgtRisk']; ?> />
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <!-- page title -->
        <title><?=$titleContent['title']['environmentalMgtRisk']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "environmentalMgtRisk.php"; ?>
