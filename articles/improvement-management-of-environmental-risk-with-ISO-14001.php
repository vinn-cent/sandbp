...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['environmentalRisk']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['environmentalRisk']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['environmentalRisk']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['environmentalRisk']['desc']; ?>"/>
        <meta property="og:url" content="<?= $canonicalTag['environmentalRisk']; ?>"/>
        <meta property="og:type" content="<?= $metaContent['environmentalRisk']['ogType']; ?>"/>
        <meta property="og:image:secure" content="<?= $metaContent['environmentalRisk']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['environmentalRisk']; ?> />
	...
	/* Add your own Mailchimp form style overrides in your site stylesheet or in this style block.
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
        ...
        <!-- page title -->
        <title><?=$titleContent['title']['environmentalRisk']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "environment-risk-contents.php"; ?>
