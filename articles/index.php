...
<html lang="en">
    <head>
        ...
        <!-- other meta set -->
        <meta name="keywords" content="<?= $metaContent['mainarticle']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['mainarticle']['desc']; ?>">

        <!-- open graph data for social media display -->
        <meta property="og:title" content="<?=$metaContent['mainarticle']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['mainarticle']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['article']; ?>/>
        <meta property="og:type" content=<?= $metaContent['mainarticle']['ogType']; ?>/>
        
        <!-- <meta property="og:image" content="<?= $metaContent['mainarticle']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['mainarticle']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['article']; ?> />
        <title><?=$titleContent['title']['mainarticle']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "articlecontent.php"; ?>
