...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['valueAccreditation']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['valueAccreditation']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['valueAccreditation']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['valueAccreditation']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['valueAccreditation']; ?>/>
        <meta property="og:type" content=<?= $metaContent['valueAccreditation']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['valueAccreditation']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['valueAccreditation']; ?> />
        <!-- page title -->

        <!-- mailchimp -->
        <link href="//cdn-images.mailchimp.com/embedcode/classic-10_7_dtp.css" rel="stylesheet" type="text/css">
        <title><?=$titleContent['title']['valueAccreditation']; ?></title>
    ...
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "accreditationContent.php"; ?>
