...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['ISO8583']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['ISO8583']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['ISO8583']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['ISO8583']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['ISO8583']; ?>/>
        <meta property="og:type" content=<?= $metaContent['ISO8583']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['ISO8583']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['ISO8583']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['ISO8583']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "ISO8583contents.php"; ?>
