...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['login']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['login']['desc']; ?>">
        <!-- open graph data for social media display -->
        <meta property="og:title" content="<?=$metaContent['login']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['login']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['login']; ?>/>
        <meta property="og:type" content=<?= $metaContent['login']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['login']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['login']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['login']; ?> />
        <title><?=$titleContent['title']['login']; ?></title>
    </head>
