...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['humanCapital']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['humanCapital']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['humanCapital']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['humanCapital']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['humanCapital']; ?>/>
        <meta property="og:type" content=<?= $metaContent['humanCapital']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['humanCapital']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['humanCapital']; ?> />
        <title><?=$titleContent['title']['humanCapital']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "humanCapitalContents.php"; ?>
