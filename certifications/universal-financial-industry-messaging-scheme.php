...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['UFIMS']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['UFIMS']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['UFIMS']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['UFIMS']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['UFIMS']; ?>/>
        <meta property="og:type" content=<?= $metaContent['UFIMS']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['UFIMS']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['UFIMS']; ?> />
        <title><?=$titleContent['title']['UFIMS']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "UFIMS-contents.php"; ?>
