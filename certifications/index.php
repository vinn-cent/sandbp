...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['certifications']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['certifications']['desc']; ?>">
        <!-- open graph data for social media display -->
        <meta property="og:title" content="<?=$metaContent['certifications']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['certifications']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['certifications']; ?>/>
        <meta property="og:type" content=<?= $metaContent['certifications']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['certifications']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['certifications']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['certifications']; ?> />
        <title><?=$titleContent['title']['certifications']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "certificationcontent.php"; ?>
        ...
        <!-- javascript -->
        <!-- <script src="./assets/scripts/jquery.min.js.download"></script> -->
