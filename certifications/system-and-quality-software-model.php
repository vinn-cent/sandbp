...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['SAQSM']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['SAQSM']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['SAQSM']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['SAQSM']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['SAQSM']; ?>/>
        <meta property="og:type" content=<?= $metaContent['SAQSM']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['SAQSM']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['SAQSM']; ?> />
        <title><?=$titleContent['title']['SAQSM']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "saqsm-contents.php"; ?>
