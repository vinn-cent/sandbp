...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['ftcom']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['ftcom']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['ftcom']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['ftcom']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['ftcom']; ?>/>
        <meta property="og:type" content=<?= $metaContent['ftcom']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['ftcom']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['ftcom']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['ftcom']; ?> />
        <title><?=$titleContent['title']['ftcom']; ?></title>
    </head>
