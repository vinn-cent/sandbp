...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['environmental']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['environmental']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['environmental']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['environmental']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['environmental']; ?>/>
        <meta property="og:type" content=<?= $metaContent['environmental']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['environmental']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['environmental']; ?> />
        <title><?=$titleContent['title']['environmental']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "environmentalContents.php"; ?>
