...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['privacy']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['privacy']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['privacy']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['privacy']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['privacy']; ?>/>
        <meta property="og:type" content=<?= $metaContent['privacy']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['privacy']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['privacy']; ?> />
        <title><?=$titleContent['title']['privacy']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "privacyContents.php"; ?>
