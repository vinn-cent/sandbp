...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['supplyChain']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['supplyChain']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['supplyChain']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['supplyChain']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['supplyChain']; ?>/>
        <meta property="og:type" content=<?= $metaContent['supplyChain']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['supplyChain']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['supplyChain']; ?> />
        <title><?=$titleContent['title']['supplyChain']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "supplyChainContents.php"; ?>
