...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['risk']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['risk']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['risk']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['risk']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['risk']; ?>/>
        <meta property="og:type" content=<?= $metaContent['risk']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['risk']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['risk']; ?> />
        <title><?=$titleContent['title']['risk']; ?></title>
    </head>
