...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['asset']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['asset']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['asset']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['asset']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['asset']; ?>/>
        <meta property="og:type" content=<?= $metaContent['asset']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['asset']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['asset']; ?> />
        <title><?=$titleContent['title']['asset']; ?></title>
    </head>
