...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['internalAudit']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['internalAudit']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['internalAudit']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['internalAudit']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['internalAudit']; ?>/>
        <meta property="og:type" content=<?= $metaContent['internalAudit']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['internalAudit']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['internalAudit']; ?> />
        <title><?=$titleContent['title']['internalAudit']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "internalAuditContents.php"; ?>
