...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['isms']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['isms']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['isms']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['isms']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['isms']; ?>/>
        <meta property="og:type" content=<?= $metaContent['isms']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['isms']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['isms']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['isms']; ?> />
        <title><?=$titleContent['title']['isms']; ?></title>
    </head>
