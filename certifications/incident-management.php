...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['incident']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['incident']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['incident']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['incident']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['incident']; ?>/>
        <meta property="og:type" content=<?= $metaContent['incident']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['incident']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['incident']; ?> />
        <title><?=$titleContent['title']['incident']; ?></title>
    </head>
