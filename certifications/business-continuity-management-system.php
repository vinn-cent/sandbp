...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['BCMS']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['BCMS']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['BCMS']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['BCMS']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['BCMS']; ?>/>
        <meta property="og:type" content=<?= $metaContent['BCMS']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['BCMS']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['BCMS']; ?> />
        <title><?=$titleContent['title']['BCMS']; ?></title>
    </head>
