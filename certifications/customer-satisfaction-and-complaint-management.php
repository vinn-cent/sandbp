...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['customerSatisfaction']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['customerSatisfaction']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['customerSatisfaction']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['customerSatisfaction']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['customerSatisfaction']; ?>/>
        <meta property="og:type" content=<?= $metaContent['customerSatisfaction']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['customerSatisfaction']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['customerSatisfaction']; ?> />
        <title><?=$titleContent['title']['customerSatisfaction']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "customerContents.php"; ?>
