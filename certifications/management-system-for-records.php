...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['records']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['records']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['records']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['records']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['records']; ?>/>
        <meta property="og:type" content=<?= $metaContent['records']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['records']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['records']; ?> />
        <title><?=$titleContent['title']['records']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "managementContents.php"; ?>
