...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['QMS']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['QMS']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['QMS']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['QMS']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['QMS']; ?>/>
        <meta property="og:type" content=<?= $metaContent['QMS']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['QMS']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['QMS']; ?> />
        <title><?=$titleContent['title']['QMS']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "qualityContents.php"; ?>
