...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['cloudComputing']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['cloudComputing']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['cloudComputing']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['cloudComputing']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['cloudComputing']; ?>/>
        <meta property="og:type" content=<?= $metaContent['cloudComputing']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['cloudComputing']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['cloudComputing']; ?> />
        <title><?=$titleContent['title']['cloudComputing']; ?></title>
    </head>
