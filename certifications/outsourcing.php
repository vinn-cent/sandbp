...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['outsourcing']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['outsourcing']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['outsourcing']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['outsourcing']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['outsourcing']; ?>/>
        <meta property="og:type" content=<?= $metaContent['outsourcing']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['outsourcing']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['outsourcing']; ?> />
        <title><?=$titleContent['title']['outsourcing']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "outsourcingContents.php"; ?>
