...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['sixSigma']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['sixSigma']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['sixSigma']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['sixSigma']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['sixSigma']; ?>/>
        <meta property="og:type" content=<?= $metaContent['sixSigma']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['sixSigma']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['sixSigma']; ?> />
        <title><?=$titleContent['title']['sixSigma']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "sixSigmaContents.php"; ?>
