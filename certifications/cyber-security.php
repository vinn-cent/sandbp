...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['cyber']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['cyber']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['cyber']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['cyber']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['cyber']; ?>/>
        <meta property="og:type" content=<?= $metaContent['cyber']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['cyber']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['cyber']; ?> />
        <title><?=$titleContent['title']['cyber']; ?></title>
    </head>
