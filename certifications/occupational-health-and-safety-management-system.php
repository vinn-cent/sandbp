...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['occupational']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['occupational']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['occupational']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['occupational']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['occupational']; ?>/>
        <meta property="og:type" content=<?= $metaContent['occupational']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['occupational']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['occupational']; ?> />
        <title><?=$titleContent['title']['occupational']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "occupationalContents.php"; ?>
