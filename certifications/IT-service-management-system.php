...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['IT-service']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['IT-service']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['IT-service']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['IT-service']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['IT-service']; ?>/>
        <meta property="og:type" content=<?= $metaContent['IT-service']['ogType']; ?>/>
        <meta property="og:image:secure" content="<?= $metaContent['IT-service']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['IT-service']; ?> />
        <title><?=$titleContent['title']['IT-service']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "IT-service-contents.php"; ?>
