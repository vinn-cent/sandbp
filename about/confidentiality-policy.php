...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['confidentiality']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['confidentiality']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['confidentiality']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['confidentiality']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['confidentiality']; ?>/>
        <meta property="og:type" content=<?= $metaContent['confidentiality']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['confidentiality']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['confidentiality']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['confidentiality']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['confidentiality']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "confidentialitycontent.php"; ?>
