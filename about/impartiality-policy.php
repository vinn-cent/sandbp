...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['impartiality']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['impartiality']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['impartiality']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['impartiality']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['impartiality']; ?>/>
        <meta property="og:type" content=<?= $metaContent['impartiality']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['impartiality']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['impartiality']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['impartiality']; ?> />
        <title><?=$titleContent['title']['impartiality']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "impartialitycontent.php"; ?>
