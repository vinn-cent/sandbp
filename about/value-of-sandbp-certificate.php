...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['valueOfSandBP']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['valueOfSandBP']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['valueOfSandBP']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['valueOfSandBP']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['value']; ?>/>
        <meta property="og:type" content=<?= $metaContent['valueOfSandBP']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['valueOfSandBP']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['valueOfSandBP']['ogImage']; ?>"/>
        ...
        <title><?=$titleContent['title']['valueOfSandbp']; ?></title>
    </head>
