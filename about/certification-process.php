...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['certificationProcess']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['certificationProcess']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['certificationProcess']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['certificationProcess']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['certificationProcess']; ?>/>
        <meta property="og:type" content=<?= $metaContent['certificationProcess']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['certificationProcess']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['certificationProcess']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['certificationProcess']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['certificationProcess']; ?></title>
    </head>
