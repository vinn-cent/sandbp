...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['mainabout']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['mainabout']['desc']; ?>">
        <!-- open graph data for social media display -->
        <meta property="og:title" content="<?=$metaContent['mainabout']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['mainabout']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['about']; ?>/>
        <meta property="og:type" content=<?= $metaContent['mainabout']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['mainabout']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['mainabout']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['about']; ?> />
        <title><?=$titleContent['title']['about']; ?></title>
    </head>
