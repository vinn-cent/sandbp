...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['codeOfEthics']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['codeOfEthics']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['codeOfEthics']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['codeOfEthics']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['codeOfEthics']; ?>/>
        <meta property="og:type" content=<?= $metaContent['codeOfEthics']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['codeOfEthics']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['codeOfEthics']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['codeOfEthics']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['codeOfEthics']; ?></title>
    </head>
