...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['complaint']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['complaint']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['complaint']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['complaint']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['complaint']; ?>/>
        <meta property="og:type" content=<?= $metaContent['complaint']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['complaint']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['complaint']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['complaint']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['complaint']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "complaintcontent.php"; ?>
