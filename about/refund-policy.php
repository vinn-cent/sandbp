...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['refund']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['refund']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['refund']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['refund']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['refund']; ?>/>
        <meta property="og:type" content=<?= $metaContent['refund']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['refund']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['refund']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['refund']; ?> />
        <title><?=$titleContent['title']['refund']; ?></title>
    </head>
