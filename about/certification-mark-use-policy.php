...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['markUsePolicy']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['markUsePolicy']['desc']; ?>">
        <!-- open graph data for social media presentation -->
        <meta property="og:title" content="<?=$metaContent['markUsePolicy']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['markUsePolicy']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['markUsePolicy']; ?>/>
        <meta property="og:type" content=<?= $metaContent['markUsePolicy']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['markUsePolicy']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['markUsePolicy']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['markUsePolicy']; ?> />
        <!-- page title -->
        <title><?=$titleContent['title']['markUsePolicy']; ?></title>
    </head>
    <body class="dc-six" data-new-gr-c-s-check-loaded="14.1021.0" data-gr-ext-installed="" style="overflow: hidden;">
        ...
        <div class="box-wrapper">
            ...
            <!-- Main Wrapper -->
            <?php include "markusecontent.php"; ?>
