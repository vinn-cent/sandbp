...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?= $metaContent['contact']['keyword']; ?>">
        <meta name="description" content="<?= $metaContent['contact']['desc']; ?>">
        <!-- open graph data for social media display -->
        <meta property="og:title" content="<?=$metaContent['contact']['ogTitle']?>"/>
        <meta property="og:description" content="<?= $metaContent['contact']['desc']; ?>"/>
        <meta property="og:url" content=<?= $canonicalTag['contact']; ?>/>
        <meta property="og:type" content=<?= $metaContent['contact']['ogType']; ?>/>
        <!-- <meta property="og:image" content="<?= $metaContent['contact']['ogImage']; ?>"/> -->
        <meta property="og:image:secure" content="<?= $metaContent['contact']['ogImage']; ?>"/>
        ...
        <link rel="canonical" href=<?= $canonicalTag['contact']; ?> />
        <title><?=$titleContent['title']['contact']; ?></title>
    </head>
